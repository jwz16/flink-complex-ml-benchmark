package edu.bu.flink_complex_ml_benchmark.experiments.handlers.pipeline5;
...
public class LicensePlateDetectionHandler extends BaseModelHandler {

  private static final long serialVersionUID = -1793941438373976471L;
  
  public LicensePlateDetectionHandler() {}

  public LicensePlateDetectionHandler(ModelNode modelNode) {
    super(modelNode);
  }
